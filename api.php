...
//     Route::get('/dashboard',[DashboardController::class,'index2'])->middleware('check.user.id');
...
//         Route::get('customers/{id}','edit2')->middleware('check.user.id');
//         Route::put('customers/update/{id}','update2')->middleware('check.user.id');
//         Route::delete('customers/{id}/destroy','destroy2')->middleware('check.user.id');
//         Route::get('customer/export','export2')->middleware('check.user.id');
//         Route::post('customer/import', 'import2')->middleware('check.user.id');
//     });
...
//         Route::get('packages/{id}/edit','edit2')->middleware('check.user.id');
//         Route::put('packages/update/{service}','update2')->middleware('check.user.id');
//         Route::delete('packages/{service}/delete','destroy2')->middleware('check.user.id');
//     });
...
//         Route::get('receipts/{id}/download', 'downloadReceipt2')->middleware('check.user.id');
//         Route::post('receipts/store','store2');
//         Route::get('receipts/search-customers', 'searchCustomers2');
//         Route::get('receipts/{id}/edit', 'edit2')->middleware('check.user.id');
//         Route::put('receipts/{id}','update2')->middleware('check.user.id');
//         Route::delete('receipts/{id}/delete','destroy2')->middleware('check.user.id');
//         Route::get('receipts/show/{id}','show2')->middleware('check.user.id');
//         Route::get('receipts/{id}/download','downloadPdf2')->middleware('check.user.id');
//     });

//     Route::controller(TelecallerController::class)->group(function(){
//         Route::get('telecaller/index','index2');
//         Route::post('telecaller/store','store2')->middleware('check.user.id');
//         Route::post('telecaller/import', 'import2')->middleware('check.user.id');
//     });
...
//         Route::get('usage/therapies','therapiesUsage2');
//         Route::post('usage/updateTherapyUsage','updateTherapyUsage2');
...
//         Route::get('usage/therapies/{receipt}','getReceiptTherapies2')->name('admin.usage.therapies.get');
//     });
...
Route::prefix('admin')->group(function () {
    ...
    Route::controller(CustomerController::class)->group(function(){
        Route::get('customers/index','index2');
        Route::post('customers/store','store2');
        Route::get('customers/{id}','edit2');
        Route::put('customers/update/{id}','update2');
        Route::delete('customers/{id}/destroy','destroy2');
        Route::get('customer/export','export2');
        Route::post('customer/import', 'import2');
    });
    ...
    Route::controller(PackageController::class)->group(function(){
        Route::get('packages/index','index2');
        Route::post('packages/store','store2');
        Route::get('packages/{id}/edit','edit2');
        Route::put('packages/update/{service}','update2');
        Route::delete('packages/{service}/delete','destroy2');
    });
    ...
    Route::controller(ReceiptController::class)->group(function(){
        ...
        Route::post('receipts/store','store2');
        Route::get('receipts/search-customers', 'searchCustomers2');
        Route::get('receipts/{id}/edit', 'edit2');
        Route::put('receipts/{id}','update2');
        Route::delete('receipts/{id}/delete','destroy2');
        Route::get('receipts/show/{id}','show2');
        Route::get('receipts/{id}/download','downloadPdf2');
    });

    Route::controller(TelecallerController::class)->group(function(){
        Route::get('telecaller/index','index2');
        Route::post('telecaller/store','store2');
        Route::post('telecaller/import', 'import2');
    });
